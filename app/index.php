...
$routes = [
    [ "name" => "Tabulation"      , "route" => "/mmfoundation-unep"     ],
    ...
    [ "name" => "Top 5 (Male)"    , "route" => "results/top5/male.php"   ],
    [ "name" => "Top 5 (Female)"  , "route" => "results/top5/female.php" ]
];
?>
<!DOCTYPE html>
<html>
    ...
    <div class="container d-flex align-items-center justify-content-center" style="min-height: 100vh;" >
        <div>
            <div class="text-center mb-5" >
                ...
                <h1 class="fw-bold" >mmfoundation-unep</h1>
                <p class="fst-italic" >Mr. and Ms. Foundation 2024</p>
            </div>
